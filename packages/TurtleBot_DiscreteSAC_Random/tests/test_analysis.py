"""The standalone Discrete SAC analysis renders every declared table and figure.

The rendering fixture uses a temporary package copy with a self-consistent
one-seed, 40-transition pilot protocol. Production campaign completeness is
never weakened to make this smoke test pass.
"""
...
class AnalysisTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        train = os.path.join(cls.tmp.name, "results", "pilot", "discretesac", "seed_101", "job_1")
        ...
        ev = os.path.join(cls.tmp.name, "results", "pilot", "discretesac", "seed_101", "eval_1")
    ...
    def test_tables_in_three_formats(self):
        ...
        for name in ("T-R1_main_results", "T-R2_learning_efficiency", "T-R3_generalization",
