...
class IdentityTests(unittest.TestCase):
    ...
    def test_identity_round_trip_and_phase_validation(self):
        identity = build_identity("e", "DiscreteSAC", "1.0.2", "random", 101, "phase1_mixed", 7000, 7001, 7002, 9001, "c" * 64, "d" * 64, "a" * 64, "b" * 64, "1.0.2", "training", "controlled", "job")
        ...
        with self.assertRaises(ValueError):
            build_identity("e", "DiscreteSAC", "1.0.0", "random", 101, "w", 1, 1, 1, 1, "c" * 64, "d" * 64, "s" * 64, "r" * 64, "1", "training", "full", "job")
        with self.assertRaises(ValueError):
            build_identity("e", "DiscreteSAC", "1.0.0", "random", 101, "w", 1, 1, 1, 1, "short", "d" * 64, "s" * 64, "r" * 64, "1", "training", "controlled", "job")
