...
def _validate_updates(report, updates, algorithm, params, budget) -> None:
    ...
    if algorithm == "DiscreteSAC":
        ...
        report.check(
            sac_ok,
            "Discrete SAC actor/twin-critic losses, entropy, probabilities, fixed alpha, learning rates and uniform replay satisfy the frozen contract",
        )
