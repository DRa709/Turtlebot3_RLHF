...
setup(
    ...
    description="TurtleBot3 Burger Phase-1 discrete navigation, random-initial-state arm: Discrete SAC package.",
    license="MIT",
    entry_points={
        "console_scripts": [
            "drl_environment = turtlebot3_drl_nav.drl_environment_node:main",
            "discretesac_agent = turtlebot3_drl_nav.discretesac_agent_node:main",
