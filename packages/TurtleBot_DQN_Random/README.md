# TurtleBot3 DQN navigation 1.1.7

DQN navigation for TurtleBot3 Burger using ROS 2 Foxy, Gazebo 11, and CPU PyTorch.
This directory contains the learner, environment configuration, simulation assets,
ARC job scripts, and analysis tools for the DQN experiment.

## Algorithm and environment

A value-based learner with uniform replay and a target network.
...
Package version `1.1.7` is defined by `VERSION` and used by the package metadata
...
| Path | Purpose |
| --- | --- |
| `turtlebot3_drl_nav/dqn.py` | Learner, updates, and checkpoints |
| `turtlebot3_drl_nav/dqn_agent_node.py` | ROS learner interface |
| `config/phase1_dqn.yaml` | Algorithm parameters |
