...
setup(
    ...
    description="TurtleBot3 Burger Phase-1 discrete navigation, random-initial-state arm: Dueling Double DQN package.",
    license="MIT",
    entry_points={
        "console_scripts": [
            "drl_environment = turtlebot3_drl_nav.drl_environment_node:main",
            "duelingdoubledqn_agent = turtlebot3_drl_nav.duelingdoubledqn_agent_node:main",
