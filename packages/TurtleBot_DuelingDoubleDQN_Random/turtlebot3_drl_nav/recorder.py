...
UPDATES_COLUMNS = [
    ...
    # Dueling-architecture diagnostics
    "state_value_mean", "centered_advantage_abs_mean",
    # Rainbow-only
    "beta_is", "mean_priority", "max_priority", "noisy_sigma_mean", "n_step", "mean_effective_n_step",
    # Discrete-SAC-only
    "alpha", "policy_entropy", "actor_loss", "critic_loss_1", "critic_loss_2",
]
...
UPDATE_APPLICABILITY: Dict[str, List[str]] = {
    "DQN": UPDATE_FIELDS_COMMON + ["epsilon"],
    "DoubleDQN": UPDATE_FIELDS_COMMON + ["epsilon"],
    "DuelingDoubleDQN": UPDATE_FIELDS_COMMON + [
    ...
    "DiscreteSAC": [
        "gradient_step", "env_step", "loss", "td_error_abs_mean", "q_taken_mean", "target_mean",
        "grad_norm", "learning_rate", "target_synced", "batch_terminal_fraction", "batch_size",
        "replay_size", "alpha", "policy_entropy", "actor_loss", "critic_loss_1", "critic_loss_2",
    ],
}
