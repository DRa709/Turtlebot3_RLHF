"""The standalone Rainbow analysis renders every declared table and figure.
...
class AnalysisTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        train = os.path.join(cls.tmp.name, "results", "pilot", "rainbowdqn", "seed_101", "job_1")
        ...
        ev = os.path.join(cls.tmp.name, "results", "pilot", "rainbowdqn", "seed_101", "eval_1")
