#!/usr/bin/env python3
"""Draw the random-arm figures (F-R1 … F-R14) from completed run directories and
...
def main() -> int:
    ...
    parser.add_argument("--expected-algorithms", default="", help="comma-separated campaign identities; when set, an incomplete evidence matrix is fatal")
