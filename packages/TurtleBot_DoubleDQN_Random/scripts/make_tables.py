...
def main() -> int:
    ...
    parser.add_argument("--expected-algorithms", default="", help="comma-separated campaign identities; when set, missing/duplicate seeds and tier-2 checkpoints are fatal")
